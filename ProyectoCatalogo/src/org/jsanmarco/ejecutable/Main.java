...
public class Main {
	...
	public static void main(String[] args) {
		...
		productos[2] = new Libro(20500.00, new Date(), "Jose Hernandez", "Martin Fierro", "--");
		productos[3] = new IPhone(220000.00, "Apple", "13 pro max", "Verde");
		productos[4] = new TvLcd(50000.00, "Samsumg", 32);
		productos[5] = new Libro(4000.00, new Date(), "Antonie de Saint", "El Principito", "el gato de hojalata");
